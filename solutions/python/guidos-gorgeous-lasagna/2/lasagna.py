...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - preparation time (in minutes) you would spend making the layers.
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :return: int - your preparation time layering + the time the lasagna has spent baking in the oven.
